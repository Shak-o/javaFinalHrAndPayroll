...
public class CustomSalaryView {
    ...
    public CustomSalaryView(String emp_id, double component1, double component2, double component3, double component4, double component5, double component6, double calculatedSalary) {
        this.emp_id = emp_id;
